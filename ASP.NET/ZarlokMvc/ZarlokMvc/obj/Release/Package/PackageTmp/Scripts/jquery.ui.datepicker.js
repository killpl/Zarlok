...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		monthNamesShort: ['styczeñ', 'luty', 'marzec', 'kwiecieñ', 'maj', 'czerwiec', 'lipiec', 'sierpieñ', 'wrzesieñ', 'paŸdziernik', 'listopad', 'grudzieñ'],
		dayNames: ['niedziela', 'poniedzia³ek', 'wtorek', 'œroda', 'czwartek', 'pi¹tek', 'sobota'],
		dayNamesShort: ['ndz.', 'pon.', 'wt.', 'œr.', 'czw.', 'pt.', 'sob.'],
		dayNamesMin: ['Ndz','Pon','Wt','Œr','Czw','Pt','Sb'], // Column headings for days starting at Sunday
